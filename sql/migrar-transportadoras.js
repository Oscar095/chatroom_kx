// Crea kx.transportadoras si no existe. Es idempotente: se puede correr las
// veces que sea. No borra ni modifica nada existente.
//
//   cd chatroom && node sql/migrar-transportadoras.js
...
(async () => {
    const ddl = fs.readFileSync(path.join(__dirname, 'transportadoras.sql'), 'utf8');
    ...
    const r = await pool.request().query(`
        SELECT COLUMN_NAME, DATA_TYPE, IS_NULLABLE, CHARACTER_MAXIMUM_LENGTH
         ...
         WHERE TABLE_SCHEMA = 'kx' AND TABLE_NAME = 'transportadoras'
